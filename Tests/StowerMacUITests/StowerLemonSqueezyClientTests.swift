...
/// The activate client's form-encoding (I9), outcome classification (I10),
/// no-PII decode (I12), and product-identity gate — all driven by a stub
...
@Suite internal struct StowerLemonSqueezyClientTests {
    ...
    @Test("a valid key for ANOTHER store/product classifies as .invalid")
    ...
    @Test("activated:true with no meta classifies as .invalid (can't confirm the product)")
